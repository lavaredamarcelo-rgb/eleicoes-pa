...
// cada candidato daquele cargo no município escolhido, sem repetir as
// informações completas da página do município.
export default async function DisputaMunicipioPage({
  ...
  const totalVotos = ranking.reduce((s, c) => s + c.votos, 0);
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-neutral-500">
          {municipio ? municipio.nome : "Pará (estadual)"} ·{" "}
          {totalVotos.toLocaleString("pt-BR")} votos nominais
        </p>
      </div>
