...
CREATE TABLE "new_Cargo" (
    ...
    "municipioId" TEXT,
    "subJudice" BOOLEAN NOT NULL DEFAULT false,
    "obsJudicial" TEXT,
...
INSERT INTO "new_Cargo" ("eleicaoId", "id", "municipioId", "nome", "tipoApuracao", "vagas") SELECT "eleicaoId", "id", "municipioId", "nome", "tipoApuracao", "vagas" FROM "Cargo";
DROP TABLE "Cargo";
